...
import { Armchair, Table2, CircleDot, BookmarkPlus, Sofa, Package } from "lucide-react";

const categories = [
  { name: "Stühle", icon: CircleDot, href: "/kategorien/stuehle", description: "Ergonomische und stilvolle Stühle" },
  { name: "Tische", icon: Table2, href: "/kategorien/tische", description: "Hochwertige Tische" },
  { name: "Sessel", icon: Armchair, href: "/kategorien/sessel", description: "Komfortable Sessel" },
  { name: "Schränke", icon: BookmarkPlus, href: "/kategorien/schraenke", description: "Stilvolle Aufbewahrung" },
  { name: "Akustik", icon: Sofa, href: "/kategorien/akustik", description: "Optimale Raumakustik" },
  { name: "Zubehör", icon: Package, href: "/kategorien/zubehoer", description: "Ergänzende Accessoires" }
];

export const meta: MetaFunction = () => {
  return [
    { title: "Premium Möbel Store" },
    { name: "description", content: "Willkommen in unserem Premium Möbel Store" },
  ];
};
  ...
  const data: LoaderData = {
    ...
    middleColumn: [
      {
        ...
        image: "https://images.unsplash.com/photo-1577140917170-285929fb55b7?w=1200",
    ...
    rightColumn: [
      ...
      },
      {
        ...
        image: "https://images.unsplash.com/photo-1577140917170-285929fb55b7?w=400",
...
export default function Index() {
  const { leftColumn, middleColumn, rightColumn } = useLoaderData<typeof loader>();
          ...
          <div className="grid grid-cols-2 gap-4">
            {categories.map((category) => (
              ...
              >
                ...
                <p className="mt-1 text-xs text-gray-500 text-center">{category.description}</p>
              </Link>
            ))}
          </div>
        </div>
            ...
            <div className="md:col-span-1 lg:col-span-6 grid grid-rows-2 md:grid-rows-8 gap-4 h-[600px] md:h-[600px] lg:h-full">
              ...
              <div className="row-span-1 md:row-span-3 grid grid-cols-2 gap-4">
                <div className="h-full">
                  {renderCard(middleColumn[1])}
                </div>
                <div className="h-full">
                  {renderCard(middleColumn[2])}
                </div>
              </div>
